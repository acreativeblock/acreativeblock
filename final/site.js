(function(){
  ...
  if(!document.querySelector('link[href*="otherhalf-home.css"]')){var ohHome=document.createElement('link');ohHome.rel='stylesheet';ohHome.href='../otherhalf-home.css?v=35';document.head.appendChild(ohHome)}
  if(!document.querySelector('link[href*="otherhalf-sub.css"]')){var ohSub=document.createElement('link');ohSub.rel='stylesheet';ohSub.href='../otherhalf-sub.css?v=21';document.head.appendChild(ohSub)}
  ...
  if(headerHost)headerHost.innerHTML='<header class="site-header oh-header"><div class="inner"><a class="oh-logo" href="../" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="3lines" data-acb-mode="none"></span></a><div class="oh-head-right"><nav class="oh-nav hdr-main" aria-label="Main navigation"><span class="menu navitem"><a class="navbutton" href="../for-individuals/">For individuals</a></span><span class="menu navitem"><a class="navbutton" href="../for-organisations/">For organisations</a></span><span class="menu navitem"><button class="navbutton">Research &amp; method</button><span class="submenu mega oh-sub"><a href="../method/">The CRAFT method</a><a href="../the-block-map/">The 7+1 map</a><a href="../the-factors/">The factors</a><a href="../evidence/">The evidence</a></span></span><span class="menu navitem"><button class="navbutton">About us</button><span class="submenu mega oh-sub"><a href="../about/">About the founder</a><a href="../contact/">Contact</a><a href="../faq/">FAQ</a></span></span></nav><div class="oh-actions"><span class="oh-social"><a href="https://www.linkedin.com/company/acreativeblock/" target="_blank" rel="noopener" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9h4v12H3zM10 9h3.8v1.7h.06c.53-.95 1.83-1.95 3.76-1.95 4.03 0 4.78 2.65 4.78 6.1V21h-4v-5.3c0-1.27-.03-2.9-1.77-2.9-1.77 0-2.04 1.38-2.04 2.8V21h-4z"/></svg></a><a href="https://www.instagram.com/a.creative.block/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" stroke="none"/></svg></a></span><a class="oh-utility-pill" href="../contact/">Book a call</a></div></div><button class="mobile-menu-toggle" type="button" aria-expanded="false" aria-label="Open menu">Menu</button></div></header>';
