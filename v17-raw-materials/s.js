// always land at the top on load/refresh (no scroll restoration, no animated scroll-up)
...
(function(){var p=(location.pathname.split('/').pop()||'index.html').toLowerCase();document.querySelectorAll('.navblk').forEach(function(a){if((a.getAttribute('href')||'').split('/').pop().toLowerCase()===p)a.classList.add('here')});})();

(function(){var p=(location.pathname.split('/').pop()||'index.html').toLowerCase();document.querySelectorAll('.navbtn').forEach(function(a){if((a.getAttribute('href')||'').split('/').pop().toLowerCase()===p)a.classList.add('here')});})();
