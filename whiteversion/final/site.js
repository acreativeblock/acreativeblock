(function(){
  ...
  if(!document.querySelector('link[href*="otherhalf-home.css"]')){var ohHome=document.createElement('link');ohHome.rel='stylesheet';ohHome.href='../otherhalf-home.css?v=38';document.head.appendChild(ohHome)}
  if(!document.querySelector('link[href*="otherhalf-sub.css"]')){var ohSub=document.createElement('link');ohSub.rel='stylesheet';ohSub.href='../otherhalf-sub.css?v=23';document.head.appendChild(ohSub)}
