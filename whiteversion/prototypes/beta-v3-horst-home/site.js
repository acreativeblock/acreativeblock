(function(){
  ...
  if(!document.querySelector('link[href^="horst-pages.css"]')){var horstStyles=document.createElement('link');horstStyles.rel='stylesheet';horstStyles.href='horst-pages.css?v=19';document.head.appendChild(horstStyles)}
  ...
  if(headerHost)headerHost.innerHTML='<header class="site-header horst-header"><div class="inner"><a class="horst-logo" href="index.html" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="1line" data-acb-mode="eye"></span></a><nav class="hdr-main" aria-label="Main navigation"><span class="menu navitem"><button class="navbutton">Our research</button><span class="submenu mega"><a href="blocks.html"><strong>The 7+1 map</strong></a><a href="evidence.html"><strong>Evidence + limits</strong></a><a href="factors.html"><strong>The factors</strong></a><a href="method.html"><strong>The CRAFT method</strong></a></span></span><span class="menu navitem"><button class="navbutton">Work together</button><span class="submenu mega"><a href="individuals.html"><strong>For individuals</strong></a><a href="organisations.html"><strong>For organisations</strong></a><a href="contact.html"><strong>Start a conversation</strong></a></span></span><span class="menu navitem"><button class="navbutton">Read &amp; explore</button><span class="submenu mega"><a href="blog.html"><strong>Articles</strong></a><a href="resources.html"><strong>Resources</strong></a><a href="Playroom.html"><strong>Playroom</strong></a><a href="faq.html"><strong>FAQ</strong></a></span></span><span class="menu navitem"><button class="navbutton">About</button><span class="submenu mega"><a href="about.html"><strong>About the founder</strong></a><a href="contact.html"><strong>Contact</strong></a><a href="manifesto.html"><strong>Manifesto</strong></a></span></span></nav><div class="horst-actions"><a class="horst-book" href="contact.html">Book a call</a><button class="mobile-menu-toggle" type="button" aria-expanded="false" aria-label="Open menu">Menu</button></div></div></header>';
