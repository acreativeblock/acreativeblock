...
(function(){
  ...
  var headerHtml='<header class="site-header acb-header"><div class="inner"><a class="acb-logo" href="/" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="3lines" data-acb-mode="none"></span></a><div class="acb-head-right"><nav class="acb-nav hdr-main" aria-label="Main navigation"><span class="menu navitem"><a class="navbutton" href="/for-individuals/">For individuals</a></span><span class="menu navitem"><a class="navbutton" href="/for-organisations/">For organisations</a></span><span class="menu navitem"><button class="navbutton">Research &amp; method</button><span class="submenu mega acb-sub"><a href="/our-method/">How we work</a><a href="/the-block-map/">Our blocks’ map</a><a href="/evidence/">The evidence</a></span></span><span class="menu navitem"><button class="navbutton">About us</button><span class="submenu mega acb-sub"><a href="/about/">Our story</a><a href="/contact/">Contact</a><a href="/faq/">FAQ</a></span></span></nav><div class="mobile-menu-footer" aria-label="More links"><div class="mobile-menu-utility"><a href="/blog/">Blog</a><a href="/find-your-block/">Find your block</a><a href="/terms/">Terms &amp; Conditions</a><a href="/privacy/">Privacy Policy</a><a href="/cookies/">Cookies</a></div><div class="mobile-menu-socials"><a href="https://www.instagram.com/a.creative.block/" target="_blank" rel="noopener" aria-label="Instagram">'+instagram+'</a><a href="https://www.linkedin.com/company/acreativeblock/" target="_blank" rel="noopener" aria-label="LinkedIn">'+linkedin+'</a></div></div><div class="acb-actions"><span class="acb-social"><a href="https://www.linkedin.com/company/acreativeblock/" target="_blank" rel="noopener" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9h4v12H3zM10 9h3.8v1.7h.06c.53-.95 1.83-1.95 3.76-1.95 4.03 0 4.78 2.65 4.78 6.1V21h-4v-5.3c0-1.27-.03-2.9-1.77-2.9-1.77 0-2.04 1.38-2.04 2.8V21h-4z"/></svg></a><a href="https://www.instagram.com/a.creative.block/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" stroke="none"/></svg></a></span><a class="acb-utility-pill" href="/contact/">Get in touch</a></div></div><a class="mobile-header-cta" href="/contact/">Get in touch</a><button class="mobile-menu-toggle" type="button" aria-expanded="false" aria-label="Open menu"></button></div></header>';
  var quickContactHtml='<section class="acb-quick-contact"><picture class="qc-media"><source type="image/avif" srcset="/images/hero-contact-960.avif 960w, /images/hero-contact-1920.avif 1920w, /images/hero-contact-2560.avif 2560w" sizes="100vw"><img src="/images/hero-contact-1440.webp" srcset="/images/hero-contact-960.webp 960w, /images/hero-contact-1440.webp 1440w, /images/hero-contact-1920.webp 1920w" sizes="100vw" width="1440" height="961" loading="lazy" decoding="async" alt="A person taking a breath before reaching out"></picture><div class="wrap"><p class="qc-copy">Feeling ready? Send us a quick message.</p><form class="cform qc-form" action="https://api.web3forms.com/submit" method="POST"><input type="hidden" name="access_key" value="bfcaf099-6bf2-4cee-b3af-51f963899857"><input type="hidden" name="subject" value="New enquiry — A Creative Block"><input type="hidden" name="from_name" value="A Creative Block website"><input type="checkbox" name="botcheck" style="display:none" tabindex="-1" autocomplete="off" aria-hidden="true"><div class="row2"><input type="text" name="name" placeholder="Your name" autocomplete="name" required><input type="email" name="email" placeholder="Your email" autocomplete="email" required></div><textarea name="message" placeholder="Your quick message" required></textarea><label class="cform-consent qc-consent"><input type="checkbox" name="consent" value="I agree to the privacy policy" required><span>I agree to A Creative Block handling my details to reply, as described in the <a href="/privacy/">privacy policy</a>.</span></label><p class="cform-status qc-status" role="status" aria-live="polite"></p><button class="btn" type="submit">Send message</button></form></div></section>';
  var footerHtml='<footer class="acb-footer"><div class="wrap"><div class="foot-lead"><div class="mark"><a href="/" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="3lines" data-acb-mode="none" style="color:#FEFDF9"></span></a><p class="ack">For anyone shaping their creative identity, vision, and work.</p></div></div><div class="top acb-footer-links"><div class="col"><b>Work together</b><a href="/for-individuals/">For individuals</a><a href="/for-organisations/">For organisations</a><a href="/contact/">Contact</a></div><div class="col"><b>Research &amp; method</b><a href="/our-method/">How we work</a><a href="/the-block-map/">The 7+1 map</a><a href="/evidence/">The evidence</a></div><div class="col"><b>Explore</b><a href="/blog/">Blog</a><a href="/find-your-block/">Find your block</a><a href="/about/">Our story</a></div><div class="col"><b>Support</b><a href="/faq/">FAQ</a><a href="/terms/">Terms &amp; Conditions</a><a href="/privacy/">Privacy Policy</a><a href="/cookies/">Cookies</a></div></div><div class="bottom"><span>© 2026 A Creative Block · Understand the why, then move.</span></div></div></footer>';
  ...
  var mobileMenuTimer,mobileMenuScrollY=0,mobileMenuPanel=header&&header.querySelector('.acb-head-right');
  function lockMobileMenuScroll(){mobileMenuScrollY=window.scrollY||document.documentElement.scrollTop||0;document.body.style.position='fixed';document.body.style.top=(-mobileMenuScrollY)+'px';document.body.style.right='0';document.body.style.left='0';document.body.style.width='100%';document.documentElement.classList.add('menu-open')}
  function unlockMobileMenuScroll(){var wasLocked=document.body.style.position==='fixed',previousScrollBehavior=document.documentElement.style.scrollBehavior;document.body.style.removeProperty('position');document.body.style.removeProperty('top');document.body.style.removeProperty('right');document.body.style.removeProperty('left');document.body.style.removeProperty('width');document.documentElement.classList.remove('menu-open');if(wasLocked){document.documentElement.style.scrollBehavior='auto';window.scrollTo(0,mobileMenuScrollY);requestAnimationFrame(function(){if(previousScrollBehavior)document.documentElement.style.scrollBehavior=previousScrollBehavior;else document.documentElement.style.removeProperty('scroll-behavior')})}}
  function finishMobileMenuClose(event){if(event&&event.target!==mobileMenuPanel)return;if(mobileMenuPanel)mobileMenuPanel.removeEventListener('animationend',finishMobileMenuClose);clearTimeout(mobileMenuTimer);if(!header.classList.contains('menu-closing'))return;header.classList.remove('mobile-open','menu-closing');unlockMobileMenuScroll()}
  function openMobileMenu(){clearTimeout(mobileMenuTimer);if(mobileMenuPanel)mobileMenuPanel.removeEventListener('animationend',finishMobileMenuClose);header.classList.remove('menu-closing');header.classList.add('mobile-open');mobileToggle.setAttribute('aria-expanded','true');mobileToggle.setAttribute('aria-label','Close menu');lockMobileMenuScroll()}
  function closeMobileMenu(animate){if(!header.classList.contains('mobile-open'))return;mobileToggle.setAttribute('aria-expanded','false');mobileToggle.setAttribute('aria-label','Open menu');if(!animate){if(mobileMenuPanel)mobileMenuPanel.removeEventListener('animationend',finishMobileMenuClose);clearTimeout(mobileMenuTimer);header.classList.remove('mobile-open','menu-closing');unlockMobileMenuScroll();return}header.classList.add('menu-closing');clearTimeout(mobileMenuTimer);if(mobileMenuPanel)mobileMenuPanel.addEventListener('animationend',finishMobileMenuClose);mobileMenuTimer=setTimeout(finishMobileMenuClose,460)}
  ...
  document.querySelectorAll('.site-header .navbutton').forEach(function(button){
    if(button.tagName==='A')return;
    var item=button.closest('.navitem');button.setAttribute('aria-haspopup','true');button.setAttribute('aria-expanded','false');
    function setExpanded(open){button.setAttribute('aria-expanded',open?'true':'false')}
    item.addEventListener('mouseenter',function(){if(window.innerWidth>1180)setExpanded(true)});
    item.addEventListener('mouseleave',function(){if(window.innerWidth>1180)setExpanded(false)});
    item.addEventListener('focusin',function(){if(window.innerWidth>1180)setExpanded(true)});
    item.addEventListener('focusout',function(e){if(window.innerWidth>1180&&!item.contains(e.relatedTarget))setExpanded(false)});
    button.addEventListener('click',function(){if(window.innerWidth>1180)return;var open=!item.classList.contains('submenu-open');document.querySelectorAll('.site-header .navitem.submenu-open').forEach(function(other){if(other!==item){other.classList.remove('submenu-open');var otherButton=other.querySelector(':scope>button.navbutton');if(otherButton)otherButton.setAttribute('aria-expanded','false')}});item.classList.toggle('submenu-open',open);setExpanded(open)});
  });
  ...
  (function(){function pagePath(path){return path.replace(/\/index\.html$/,'/').replace(/\/+$/,'')||'/'}var current=pagePath(location.pathname);document.querySelectorAll('.acb-nav .navitem').forEach(function(item){item.querySelectorAll('a[href]').forEach(function(link){var target=pagePath(new URL(link.getAttribute('href'),location.href).pathname);if(target!==current)return;link.classList.add('is-active');link.setAttribute('aria-current','page');item.classList.add('is-active')})})})();
  ...
  document.querySelectorAll('.offer-toggle,.faq-q').forEach(function(b){
    var item=b.parentElement,answer=item.querySelector('.offer-body,.faq-a'),icon=b.querySelector('.pm');
    if(icon)icon.innerHTML='<svg viewBox="0 0 20 20" aria-hidden="true"><path d="m5 7.5 5 5 5-5"/></svg>';
    b.setAttribute('aria-expanded',item.classList.contains('open')?'true':'false');
    if(!answer)return;
    var timer=null,onEnd=null;
    function cancelFinish(){
      clearTimeout(timer);
      if(onEnd)answer.removeEventListener('transitionend',onEnd);
      onEnd=null;
    }
    ...
    function afterHeight(opening){
      onEnd=function(e){
        if(e.target!==answer||e.propertyName!=='height')return;
        finish(opening);
      };
      answer.addEventListener('transitionend',onEnd);
      timer=setTimeout(function(){finish(opening)},480);
    }
    b.addEventListener('click',function(){
      ...
      if(opening){
        ...
        answer.style.setProperty('height','0px','important');
        answer.style.setProperty('opacity','0','important');
        void answer.offsetHeight;
        requestAnimationFrame(function(){
          answer.style.setProperty('height',answer.scrollHeight+'px','important');
          answer.style.setProperty('opacity','1','important');
          afterHeight(true);
        });
      }else{
        item.classList.add('closing');
        answer.style.setProperty('height',answer.getBoundingClientRect().height+'px','important');
        answer.style.setProperty('opacity','1','important');
        void answer.offsetHeight;
        requestAnimationFrame(function(){
          answer.style.setProperty('height','0px','important');
  ...
  /* Calm shared motion. Takeaway cards keep their custom gravity animation;
     the section and its heading still join the shared reveal sequence. */
  (function(){
    if(window.matchMedia&&window.matchMedia('(prefers-reduced-motion: reduce)').matches)return;
    var main=document.querySelector('main'),observer;
    if(!main)return;
    document.documentElement.classList.add('acb-motion');
    function prepareHero(){
      var hero=main.querySelector(':scope>.acb-hero,:scope>.page-hero,:scope>.center-hero,:scope>.blog-hero,:scope>.bm-hero,:scope>.domain-hero');
      if(!hero||hero.classList.contains('acb-motion-hero'))return;
      hero.classList.add('acb-motion-hero');
      var source=hero.querySelector('.acb-hero-copy,.audience-hero-stack')||hero.querySelector(':scope>.wrap');
      if(!source)return;
      [].slice.call(source.children).forEach(function(item,index){
        item.classList.add('acb-motion-hero-item');
        item.style.setProperty('--acb-hero-delay',(Math.min(index,4)*75)+'ms');
      });
    }
    ...
    observer='IntersectionObserver'in window?new IntersectionObserver(function(entries){entries.forEach(function(entry){if(entry.isIntersecting)show(entry.target)})},{rootMargin:'0px 0px -9% 0px',threshold:.08}):null;
    function prepareSection(section,index){
      ...
      items.forEach(function(item,itemIndex){
        item.classList.add('acb-motion-item');
        item.style.setProperty('--acb-motion-delay',(Math.min(itemIndex,6)*65)+'ms');
        item.style.setProperty('--acb-motion-x',(itemIndex%2?5:-5)+'px');
      });
      if(section.getBoundingClientRect().top<window.innerHeight*.94)setTimeout(function(){show(section)},Math.min(index,3)*70);
      else if(observer)observer.observe(section);
      else show(section);
    }
    function scanMotion(){
      prepareHero();
      var sections=[].slice.call(document.querySelectorAll('main>.acb-main-panel>section,main>section,main .faqx-cat,main .method-block')).filter(function(section,index,list){return list.indexOf(section)===index});
      sections.forEach(prepareSection);
    }
    scanMotion();
    var dynamicObserver=new MutationObserver(function(){scanMotion()});
    dynamicObserver.observe(main,{childList:true,subtree:true});
    setTimeout(function(){dynamicObserver.disconnect();scanMotion()},1500);
  })();
  document.documentElement.classList.remove('acb-preload');
