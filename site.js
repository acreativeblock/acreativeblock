(function(){
  ...
  if(!document.querySelector('link[href*="sections.css"]')){var sectionsLink=document.createElement('link');sectionsLink.rel='stylesheet';sectionsLink.href='../sections.css?v=25';document.head.appendChild(sectionsLink)}
  ...
  var headerHtml='<header class="site-header acb-header"><div class="inner"><a class="acb-logo" href="../" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="3lines" data-acb-mode="none"></span></a><div class="acb-head-right"><nav class="acb-nav hdr-main" aria-label="Main navigation"><span class="menu navitem"><a class="navbutton" href="../for-individuals/">For individuals</a></span><span class="menu navitem"><a class="navbutton" href="../for-organisations/">For organisations</a></span><span class="menu navitem"><button class="navbutton">Research &amp; method</button><span class="submenu mega acb-sub"><a href="../our-method/">How we work</a><a href="../the-block-map/">Our blocks’ map</a><a href="../the-factors/">The factors</a><a href="../evidence/">The evidence</a></span></span><span class="menu navitem"><button class="navbutton">About us</button><span class="submenu mega acb-sub"><a href="../about/">Our story</a><a href="../contact/">Contact</a><a href="../faq/">FAQ</a></span></span></nav><div class="acb-actions"><span class="acb-social"><a href="https://www.linkedin.com/company/acreativeblock/" target="_blank" rel="noopener" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9h4v12H3zM10 9h3.8v1.7h.06c.53-.95 1.83-1.95 3.76-1.95 4.03 0 4.78 2.65 4.78 6.1V21h-4v-5.3c0-1.27-.03-2.9-1.77-2.9-1.77 0-2.04 1.38-2.04 2.8V21h-4z"/></svg></a><a href="https://www.instagram.com/a.creative.block/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" stroke="none"/></svg></a></span><a class="acb-utility-pill" href="../contact/">Book a call</a></div></div><button class="mobile-menu-toggle" type="button" aria-expanded="false" aria-label="Open menu">Menu</button></div></header>';
  var footerHtml='<footer class="acb-footer"><div class="wrap"><div class="foot-lead"><div class="mark"><a href="../" aria-label="A Creative Block home"><span class="acb-logo-mount" data-acb-logo="3lines" data-acb-mode="none" style="color:#FEFDF9"></span></a><p class="ack">For anyone shaping their creative identity, vision, and work.</p></div><div class="news acb-footer-news"><h3>Sign up for more</h3><p>An honest, occasional letter about creative work and how people get moving.</p><form class="acb-newsletter"><input type="email" name="email" placeholder="Your email" aria-label="Your email" required><button type="submit">Sign up ↗</button></form></div></div><div class="top acb-footer-links"><div class="col"><b>Work together</b><a href="../for-individuals/">For individuals</a><a href="../for-organisations/">For organisations</a><a href="../contact/">Contact</a></div><div class="col"><b>Research &amp; method</b><a href="../our-method/">How we work</a><a href="../the-block-map/">The 7+1 map</a><a href="../the-factors/">The factors</a><a href="../evidence/">The evidence</a></div><div class="col"><b>Read &amp; explore</b><a href="../blog/">Blog</a><a href="../find-your-block/">Find your block</a></div><div class="col"><b>About us</b><a href="../about/">Our story</a><a href="../faq/">FAQ</a><a href="https://www.instagram.com/a.creative.block/">Instagram</a><a href="https://www.linkedin.com/company/acreativeblock/">LinkedIn</a></div></div><div class="bottom"><span>© 2026 A Creative Block · Understand the why, then move.</span><div><a href="../terms/">Terms &amp; Conditions</a><a href="../privacy/">Privacy Policy</a><a href="../cookies/">Cookies</a></div></div></div></footer>';
  ...
  if(!grain){grain=document.createElement('canvas');grain.className='grain';grain.setAttribute('aria-hidden','true');document.body.appendChild(grain)}
  if(grain){var gx=grain.getContext('2d'),S=1.5,gw=0,gh=0,last=0;function resize(){gw=grain.width=Math.max(1,Math.ceil(innerWidth/S));gh=grain.height=Math.max(1,Math.ceil(innerHeight/S))}function clearMedia(){document.querySelectorAll('img,picture,video,[data-grain-exclude]').forEach(function(el){var r=el.getBoundingClientRect();if(r.bottom<=0||r.right<=0||r.top>=innerHeight||r.left>=innerWidth)return;gx.clearRect(Math.floor(r.left/S)-1,Math.floor(r.top/S)-1,Math.ceil(r.width/S)+2,Math.ceil(r.height/S)+2)})}function noise(t){if(t-last<=60)return;last=t;var im=gx.createImageData(gw,gh),d=im.data;for(var i=0;i<d.length;i+=4){var n=(Math.random()*255)|0;d[i]=d[i+1]=d[i+2]=n;d[i+3]=(Math.random()*48)|0}gx.putImageData(im,0,0);clearMedia()}resize();addEventListener('resize',resize,{passive:true});(function loop(t){noise(t);requestAnimationFrame(loop)})(0)}
  ...
  document.querySelectorAll('.offer-toggle,.faq-q').forEach(function(b){var item=b.parentElement,icon=b.querySelector('.pm');if(icon)icon.innerHTML='<svg viewBox=\"0 0 20 20\" aria-hidden=\"true\"><path d=\"m5 7.5 5 5 5-5\"/></svg>';b.setAttribute('aria-expanded',item.classList.contains('open')?'true':'false');b.addEventListener('click',function(){var open=item.classList.toggle('open');b.setAttribute('aria-expanded',open?'true':'false')})});
  var io=new IntersectionObserver(function(es){es.forEach(function(e){if(e.isIntersecting){e.target.classList.add('in');io.unobserve(e.target)}})},{threshold:.14,rootMargin:'0px 0px -17%'});document.querySelectorAll('main section,.reveal').forEach(function(x,i){x.classList.add('reveal');x.style.transitionDelay=(i%3)*55+'ms';io.observe(x)});
  document.querySelectorAll('.newsletter,.acb-newsletter').forEach(function(f){f.addEventListener('submit',function(e){e.preventDefault();var b=f.querySelector('button');b.textContent='Thank you!';b.disabled=true})});

  (function(){var t=document.querySelector('[data-carotrack]');if(!t)return;
    var cards=[].slice.call(t.querySelectorAll('.ccard')),index=0,active=false,paused=false,timer=0;
    function leftFor(i){var c=cards[i];return c?c.offsetLeft-t.offsetLeft:0;}
    function go(i){if(!cards.length)return;index=(i+cards.length)%cards.length;t.scrollTo({left:leftFor(index),behavior:'smooth'});}
    document.querySelectorAll('[data-caro]').forEach(function(b){b.addEventListener('click',function(e){e.preventDefault();go(index+(b.dataset.caro==='next'?1:-1));restart();});});
    function restart(){clearInterval(timer);timer=setInterval(function(){if(active&&!paused)go(index+1);},3300);}
    new IntersectionObserver(function(es){es.forEach(function(e){active=e.isIntersecting;});},{threshold:.28}).observe(t.closest('.acb-carousel')||t);
    ['mouseenter','pointerdown','touchstart','focusin'].forEach(function(ev){t.addEventListener(ev,function(){paused=true;});});
    ['mouseleave','pointerup','touchend','focusout'].forEach(function(ev){t.addEventListener(ev,function(){paused=false;});});
    t.addEventListener('scroll',function(){clearTimeout(t._caroSettle);t._caroSettle=setTimeout(function(){var x=t.scrollLeft,best=0,dist=Infinity;cards.forEach(function(c,i){var d=Math.abs(leftFor(i)-x);if(d<dist){dist=d;best=i;}});index=best;},100);},{passive:true});
