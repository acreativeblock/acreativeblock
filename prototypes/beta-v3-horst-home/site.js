(function(){
  ...
  if(!document.querySelector('link[href^="horst-pages.css"]')){var horstStyles=document.createElement('link');horstStyles.rel='stylesheet';horstStyles.href='horst-pages.css?v=13';document.head.appendChild(horstStyles)}
